...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\UploadsController' => 'getUploadsControllerService',
            ...
            'Vich\\UploaderBundle\\Naming\\UniqidNamer.reclamation' => 'getUniqidNamer_ReclamationService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('do2Dgpzi0F', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qppG5ltsAd', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MY65tnjl1p', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('3UHuJgf6Ve', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OvsR9u1BN5', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jbKMX-Hca6', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_token_verifier'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FyYeWKFRo3', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xKaVtlCyBJ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JcWbkoGOxm', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+EgMPDA8jK', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnection_EventManagerService()
    {
        return $this->privates['doctrine.dbal.default_connection.event_manager'] = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'vich_uploader.listener.clean.reclamation' => ['privates', 'vich_uploader.listener.clean.reclamation', 'getVichUploader_Listener_Clean_ReclamationService', true],
            'vich_uploader.listener.remove.reclamation' => ['privates', 'vich_uploader.listener.remove.reclamation', 'getVichUploader_Listener_Remove_ReclamationService', true],
            'vich_uploader.listener.upload.reclamation' => ['privates', 'vich_uploader.listener.upload.reclamation', 'getVichUploader_Listener_Upload_ReclamationService', true],
        ], [
            ...
            'vich_uploader.listener.clean.reclamation' => '?',
            'vich_uploader.listener.remove.reclamation' => '?',
            'vich_uploader.listener.upload.reclamation' => '?',
        ]), [0 => [0 => [0 => 'preUpdate'], 1 => 'vich_uploader.listener.clean.reclamation'], 1 => 'doctrine.orm.messenger.doctrine_schema_subscriber', 2 => 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_subscriber', 3 => 'doctrine.orm.listeners.pdo_cache_adapter_doctrine_schema_subscriber', 4 => 'doctrine.orm.listeners.doctrine_token_provider_schema_subscriber', 5 => [0 => [0 => 'loadClassMetadata'], 1 => 'doctrine.orm.default_listeners.attach_entity_listeners'], 6 => [0 => [0 => 'preRemove'], 1 => 'vich_uploader.listener.remove.reclamation'], 7 => [0 => [0 => 'postFlush'], 1 => 'vich_uploader.listener.remove.reclamation'], 8 => [0 => [0 => 'prePersist'], 1 => 'vich_uploader.listener.upload.reclamation'], 9 => [0 => [0 => 'preUpdate'], 1 => 'vich_uploader.listener.upload.reclamation']]);
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles_metadata' => [
                ...
                'KnpSnappyBundle' => [
                    'path' => 'C:/Users/legion 5/Desktop/userprojet/vendor/knplabs/knp-snappy-bundle/src',
            ...
            'images_directory_reclamation' => (\dirname(__DIR__, 4).'/public/images/reclamations'),
            'images_directory' => (\dirname(__DIR__, 4).'/public/uploads/imageC'),
            ...
            'twig.form.resources' => [
                ...
                2 => '@Recaptcha/form/recaptcha.html.twig',
            ...
            'vich_uploader.mappings' => [
                'reclamation' => [
                    'uri_prefix' => '/images/reclamation',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/images/reclamations'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\UniqidNamer.reclamation',
                        'options' => [
