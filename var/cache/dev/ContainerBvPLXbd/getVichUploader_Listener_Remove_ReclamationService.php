 ...
 */
class getVichUploader_Listener_Remove_ReclamationService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.remove.reclamation' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.remove.reclamation'])) {
            return $container->privates['vich_uploader.listener.remove.reclamation'];
        }

        return $container->privates['vich_uploader.listener.remove.reclamation'] = new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('reclamation', ($container->privates['vich_uploader.adapter.orm'] ?? ($container->privates['vich_uploader.adapter.orm'] = new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter())), ($container->privates['vich_uploader.metadata_reader'] ?? $container->getVichUploader_MetadataReaderService()), $a);
    }
}
