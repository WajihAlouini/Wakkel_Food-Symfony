...
class get_Messenger_HandlerDescriptor_Lml2ICsService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['.messenger.handler_descriptor.Lml2ICs'])) {
            return $container->privates['.messenger.handler_descriptor.Lml2ICs'];
        }

        return $container->privates['.messenger.handler_descriptor.Lml2ICs'] = new \Symfony\Component\Messenger\Handler\HandlerDescriptor(new \Symfony\Component\Notifier\Messenger\MessageHandler($a), []);
    }
}
