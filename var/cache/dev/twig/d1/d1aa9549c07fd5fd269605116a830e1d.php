...
class __TwigTemplate_f68e9e6d587a3e07080940de65623f63 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 1
        yield from         $this->loadTemplate("client/navbar.html.twig", "Admin/restaurant/list.html.twig", 1)->unwrap()->yield($context);
        // line 2
...
";
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["image"]) {
            // line 10
            yield "                        <img src=\"";
            yield Twig\Extension\EscaperExtension::escape($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/" . CoreExtension::getAttribute($this->env, $this->source, $context["image"], "filename", [], "any", false, false, false, 10))), "html", null, true);
            yield "\" alt=\"";
            yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["image"], "alt", [], "any", false, false, false, 10), "html", null, true);
            yield "\">
                    ";
        }
        ...
        // line 23
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["restaurants"]) || array_key_exists("restaurants", $context) ? $context["restaurants"] : (function () { throw new RuntimeError('Variable "restaurants" does not exist.', 23, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["restaurant"]) {
            // line 24
            yield "                    <div class=\"box restaurant-item\">
                        <a href=\"";
            // line 25
            yield Twig\Extension\EscaperExtension::escape($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("restaurant_plats", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["restaurant"], "idRestaurant", [], "any", false, false, false, 25)]), "html", null, true);
            yield "\">
                            <h3>";
            // line 26
            yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["restaurant"], "nomRestaurant", [], "any", false, false, false, 26), "html", null, true);
            yield "</h3>
                        </a>
                        <img src=\"";
            // line 28
            yield Twig\Extension\EscaperExtension::escape($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/" . CoreExtension::getAttribute($this->env, $this->source, $context["restaurant"], "restaurantImage", [], "any", false, false, false, 28))), "html", null, true);
            yield "\" alt=\"";
            yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["restaurant"], "nomRestaurant", [], "any", false, false, false, 28), "html", null, true);
            yield " Image\">
                        <p>Adresse: ";
            // line 29
            yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["restaurant"], "adresseRestaurant", [], "any", false, false, false, 29), "html", null, true);
            yield "</p>
                    </div>
                ";
        }
        ...
        // line 32
        yield "                ";
        yield from         $this->loadTemplate("client/footer.html.twig", "Admin/restaurant/list.html.twig", 32)->unwrap()->yield($context);
        // line 33
        yield "            </div>
    ...
    {
        return array (  147 => 33,  144 => 32,  135 => 29,  129 => 28,  124 => 26,  120 => 25,  117 => 24,  113 => 23,  100 => 12,  89 => 10,  85 => 9,  80 => 7,  76 => 5,  66 => 4,  53 => 124,  51 => 4,  47 => 2,  45 => 1,);
    }
