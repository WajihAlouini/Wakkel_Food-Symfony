...
class __TwigTemplate_669a4d395bf2972cbefe64b6e2f0bf34 extends Template
{
    private $source;
    private $macros = [];
...
<body>
    <img class=\"img-fluid full-screen-image\" src=\"";
        // line 34
        yield Twig\Extension\EscaperExtension::escape($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("Main/img/ban.png"), "html", null, true);
        yield "\" alt=\"\">
    <img class=\"img-fluid second-image\" src=\"";
        // line 35
        yield Twig\Extension\EscaperExtension::escape($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("Main/img/chaine.png"), "html", null, true);
        yield "\" alt=\"\">
</body>
...
";
    ...
    {
        return array (  86 => 35,  82 => 34,  52 => 7,  44 => 1,);
    }
